...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('veryoddshape@gmail.com', '$8uqQmS2#Fr@') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'veryoddshape@gmail.com' #Email in which you want to receice the information
$ReportEmail.To.Add('veryoddshape@gmail.com') #Email in which you want to receive the information
